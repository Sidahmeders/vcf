module.exports = ({ roomsDB, InMemoryGames, Player, createDeck, shuffleDeck }) => {
  return async (roomName) => {
    ...
    const declaredPlayers = targetRoom?.declaredPlayers ? targetRoom.declaredPlayers : {}
    ...
    const newRoomData = { cardsDeck, players: roomPlayers, droppedCards, declaredPlayers }
